...
export default function AppDataGrid({ rows, columns }: AppDataGridProps) {
...
const esESGrid = {
    ...
    footerRowSelected: (count: number) => count > 1 ? `${count.toLocaleString()} filas seleccionadas` : `${count.toLocaleString()} fila seleccionada`,
    // Total row amount footer text
    footerTotalRows: 'Filas Totales:',
    // Total visible row amount footer text
    footerTotalVisibleRows: (visibleCount: { toLocaleString: () => any; }, totalCount: { toLocaleString: () => any; }) => `${visibleCount.toLocaleString()} de ${totalCount.toLocaleString()}`,
